...
5. Толщина верхней грани v460 (не может быть больше толщины нижней грани(v459) и должна составлять 40-60%);
6. Высота стакана с уплотнением стенки v454 (не может быть отрицательной и должна составлять не менее 20% от общей высоты стакана(v456));
7. Количество граней(Сумма ширин всех граней должна быть меньше длины нижней окружности).
